...
/**
 * ShokuhinMain <br>
 * Initialising Class for Shokuhin - Creates Full Interface <br>
 * Welcome to Shokuhin!
 *
 */
public class ShokuhinMain {
	...
	public static final Color SATSUMA_MANDARIN_CLEMENTINE_ORANGE = new Color(
			255, 155, 25);
	public static final Color EASY_PEASY_LEMON_SQUEEZY_YELLOW = new Color(238,
			240, 65);
	public static final Color QUESTIONABLE_SALAD_LEAF_GREEN = new Color(92,
			200, 87);
	public static final Color FIFTY_SHADES_OF_WHITE = new Color(240, 240, 240);
	public static final Color ANY_COLOUR_SO_LONG_AS_IT_IS_BLACK = new Color(0,
			0, 0);
	public static final Color DEFAULT_CAMPUS_FOG = new Color(214, 217, 223);

	// Create fields to store the Main class, as well as the Voice Command
	// class.
	...
	/**
	 * Constructor <br>
	 * Welcome to Shokuhin! <br>
	 * Performs the Setup necessary for Shokuhin to run.
	 */
	public ShokuhinMain() {
		/*
		 * Try to set the theme the Nimbus (Cross Platform - Win/Lin/MacOS)
		 * Failing that, set the theme to the System Theme If that fails, assume
		 * there's some deep, underlying issue, which Shokuhin would only
		 * exacerbate, and therefore conclude that exiting is the best option.
		 */
		try {
			UIManager
			...
			try {
				...
				JOptionPane.showMessageDialog(null,
						"Failed to set both Nimbus theme and System theme. \n Returned the error: "
								+ e.getMessage());
				System.exit(0);
			}
		}
		...
		// Add a listener to set the Dynamic Menu on the Frame to change
...
>>>>>>> origin/master
	...
	/**
	 * Take a new ModulePanel, and add it to Shokuhin <br>
...
>>>>>>> origin/master
	...
	public void closeTab() {
		...
		// Request permission to close a Module, then close it upon receiving
		// it.
	...
	/**
	 * Returns the Shokuhin frame
	 */
	public ShokuhinFrame getParentFrame() {
		return frame;
	}

	/**
	 * Main Initialises a running instance of Shokuhin
	 */
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					// MidiPlayer.play(new Pattern(MidiPlayer.getPattern(new
					// File("INSERT '.mid' FILENAME HERE"))));
